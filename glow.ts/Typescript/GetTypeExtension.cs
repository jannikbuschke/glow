    ...
    public static class GetTypeExtension
    {
        ...
        public static readonly Dictionary<Type, Tuple<string, string>> primitives =
            new()
            {
                ...
                {typeof(List<object>), new Tuple<string, string>("any[]", "[]")},
                {typeof(Collection<object>), new Tuple<string, string>("any[]", "[]")},
                {typeof(ICollection<object>), new Tuple<string, string>("any[]", "[]")},
                {typeof(IEnumerable<object>), new Tuple<string, string>("any[]", "[]")},
